...
def reorder_features(original_dataset, selected_features_indices):
    ordered_dataset = original_dataset[:, selected_features_indices]
...
def main():
    ...
    selected_features_indices = univariate_feature_selection(dataset, labels, percentile)
    # selected_features_indices = decision_trees_based_feature_selection(dataset, labels, percentile)
    # selected_features_indices = random_forest_based_feature_selection(dataset, labels, percentile)
    # selected_features_indices = recursive_feature_selection(dataset, labels, percentile)

    # Reorder features in the original order
    dataset_selected = reorder_features(dataset, selected_features_indices)
    print("dataset_selected", dataset_selected)
