...
model_type = "bi_rnn"  # Options: rnn, bi_rnn, gru, bi_gru, lstm, bi_lstm, transformer
dataset_variant = "Data"  # Change to "Data_1000" for padded dataset
...
model_path = f"../Models/{model_type}_model_{dataset_variant}_7.pth"
