...
# Import LSTM models dynamically based on unidirectional or bidirectional choice
...
def grid_search(use_bidirectional=False):
    ...
    if use_bidirectional:
        ...
        base_results_filename = "../hyperparameter_results/LSTM_Bidirectional"
    else:
        print("\n>>> Using Unidirectional LSTM Model <<<\n")
        ModelClass = LSTMClassifier
        base_results_filename = "../hyperparameter_results/LSTM_Unidirectional"
