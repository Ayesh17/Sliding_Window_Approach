...
from Multi_Class_classification_Models.Multiclass_Bidirectional_LSTM_model import BiLSTMClassifier
from Multi_Class_classification_Models.Multiclass_LSTM_model import LSTMClassifier  # Unidirectional LSTM model

# Define whether to use bidirectional LSTM
use_bidirectional = False  # Change to True for bidirectional LSTM
...
def grid_search(dataset_variant="Data_hyperparam", use_bidirectional=False):
    ...
    # Choose the correct LSTM model based on bidirectionality
    if use_bidirectional:
        print("\n>>> Using Bidirectional LSTM Model <<<\n")
        ModelClass = BiLSTMClassifier
        base_results_filename = "../hyperparameter_results/LSTM_Bidirectional_Results.csv"
    else:
        print("\n>>> Using Unidirectional LSTM Model <<<\n")
        ModelClass = LSTMClassifier
        base_results_filename = "../hyperparameter_results/LSTM_Unidirectional_Results.csv"
