...
# Set the number of files for training, validation, and testing
train_count = 700
val_count = 150
test_count = 150
...
for behavior in behaviors:
    ...
    test_files = csv_files[train_count + val_count:train_count + val_count + test_count]
